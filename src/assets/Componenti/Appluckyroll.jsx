...
function Appluckyroll (){
    ...
    return (
      <>
        <header className="shadow-lg min-[1400px]:w-[100%] min-[500px]:w-[375px] h-[80px] top-0 bg-[#ffcb3c] absolute left-0  min-[412px]:w-[412px] min-[414px]:w-[415px] min-[430px]:w-[430px] min-[375px]:w-[375px] min-[390px]:w-[390px]">
          <div className='w-[250px] h-[50px] mt-[15px] ml-[75px] min-[375px]:ml-14 min-[412px]:ml-[80px] min-[1400px]:ml-[800px]'>
        ...
        <div className={`border-[4px] border-black w-16 h-16 mt-24 ml-[126px] min-[1400px]:ml-[200px] rounded-[10px] ${rolling ? 'animate-Roll' : ''} flex items-center justify-center min-[414px]:ml-[147px] min-[412px]:ml-[146px] min-[390px]:ml-[137px] min-[430px]:ml-[157px]`}>
        ...
        <div className="w-[180px] h-[100px] ml-[70px] mt-[45px] min-[1400px]:ml-[112px]">
