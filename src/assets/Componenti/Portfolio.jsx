...
<Link className="border-2 border-[#443e3e] w-10 h-[200px] ml-[-100px] border-none min-[1400px]:ml-[-1950px] xl:ml-[-1950px]" to="/FrancescoConvertini Portfolio">
    <div className=" border-2 border-[#443e3e] w-[260px] h-[474px] ml-[-20px] absolute mt-[214px] z-10 rounded-br-[125px] min-[1400px]:ml-[1720px] min-[1400px]:mt-[215px]
...
<Link className="border-2 border-[#443e3e] w-10 h-[200px] ml-[-100px] border-none min-[1400px]:ml-[-1950px] xl:ml-[-1950px]" to="/Lucky Roll">
    <div className="border-2 border-[#443e3e] w-[260px] h-[475px] ml-[-20px] absolute mt-[215px] z-10 rounded-br-[130px] min-[1400px]:ml-[1720px] min-[1400px]:mt-[217px]
     xl:ml-[1920px]">
    </div>
</Link>
...
<Link className="border-2 border-[#443e3e]  w-10 h-[200px] ml-[-100px] border-none min-[1400px]:ml-[-650px] xl:ml-[-1950px]" to="/Super Counter">
    <div className="border-2 border-[#443e3e] w-[260px] h-[475px] ml-[-20px] absolute mt-[215px] z-10 rounded-br-[130px] min-[1400px]:ml-[420px] min-[1400px]:mt-[217px]
    xl:ml-[1920px]">
    </div>
</Link>
...
<Link className="border-2 border-[#443e3e] w-10 h-[200px] ml-[-100px] border-none min-[1400px]:ml-[-1500px] xl:ml-[-1950px]" to="/Wanderlust Adventures">
    <div className=" border-2 border-[#443e3e] w-[260px] h-[475px] ml-[-20px] absolute mt-[215px] z-10 rounded-br-[130px] min-[1400px]:ml-[1270px] min-[1400px]:mt-[217px]
    xl:ml-[1920px]">
    </div>
</Link>
...
<Link className="border-2 border-[#443e3e] w-10 h-[200px] ml-[-100px] border-none min-[1400px]:ml-[-1500px] xl:ml-[-1950px]" to="/Airnote">
    <div className="border-2 border-[#443e3e] w-[260px] h-[475px] ml-[-20px] absolute mt-[215px] z-10 rounded-br-[130px] min-[1400px]:ml-[1270px] min-[1400px]:mt-[217px]
    xl:ml-[1920px]">
    </div>
</Link>
...
<Link className="border-2 border-[#443e3e] w-10 h-[200px] ml-[-100px] border-none min-[1400px]:ml-[-1000px] xl:ml-[-1950px]" to="/GreenThreads">
    <div className="border-2 border-[#443e3e] w-[260px] h-[475px] ml-[-20px] absolute mt-[215px] z-10 rounded-br-[130px] min-[1400px]:ml-[770px] min-[1400px]:mt-[217px]
    xl:ml-[1920px]">
    </div>
</Link>
...
<Link className="border-2 border-[#443e3e] w-10 h-[200px] ml-[-100px] border-none min-[1400px]:ml-[-1500px] xl:ml-[-1950px]" to="/The Thing under the bed">
    <div className="border-2 border-[#443e3e] w-[260px] h-[475px] ml-[-20px] absolute mt-[215px] z-10 rounded-br-[130px]  min-[1400px]:ml-[1270px] min-[1400px]:mt-[217px]
    xl:ml-[1920px]">
    </div>
</Link>
