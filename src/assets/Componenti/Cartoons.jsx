        ...
        <>
            ...
            <Navbar></Navbar>
                ...
                <div className="flex justify-center items-center mt-[300px]">
                    <h1 className=" text-white text-[36px] text-left min-[1400px]:text-[70px] xl:text-[50px]">GreenThreads
                    </h1>
                </div>
                ...
                <div className="flex justify-center items-center mt-[300px]">
                    <h1 className=" text-white text-[30px] text-left min-[1400px]:text-[70px]">Creazione del logo</h1>
                </div>


                <div className="flex justify-center items-center mt-[90px]">
                    <p className=" text-white text-[17px] text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">Il negozio di abbigliamento sostenibile GreenThreads 
                ...
                <div className="flex justify-center items-center flex-col">
                    <p className="text-white text-[17px] mt-[200px] text-left font-semibold min-[1400px]:text-[26px] min-[768px]:text-[22px]">Fase di progettazione:</p>
                        ...
                        <p className="text-white text-[17px] mt-[200px] text-left font-semibold min-[1400px]:text-[26px] min-[768px]:text-[22px] min-[1400px]:mt-[-100px] 
                ...
                <div className="flex justify-center items-center mt-[100px]">
                    <p className=" text-white text-[17px] text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">Il suo colore verde va a richiamare natura, 
                ...
                <div className="flex justify-center items-center mt-[90px]">
                    <p className=" text-white text-[17px] text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">Il font utilizzato per questo logo è il Poppins Bold.</p>
                </div>

                <div className="flex justify-center items-center mt-[300px]">
                    <h1 className=" text-white text-[30px] scale-120 text-left">Mockup</h1>
                </div>
