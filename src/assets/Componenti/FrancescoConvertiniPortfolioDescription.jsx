    ...
    return(
        ...
        <>
            ...
            min-[768px]:ml-[10px] min-[768px]:w-[500px]">
                <h1 className="text-black text-[30px] ml-5 text-left  min-[1400px]:text-[70px] xl:text-[50px]">
            ...
            min-[768px]:ml-[10px] min-[768px]:w-[500px]">
                <p className=" text-black text-[20px] ml-5 text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">
                    Sito web personale per far conoscere e mostrare le proprie abilità di graphic design e programazzione.
                </p>
            </div>
            ...
            min-[768px]:ml-[10px] min-[768px]:w-[500px]">
                <li className='text-black text-[18px] ml-12 text-left min-[1400px]:text-[26px] min-[768px]:text-[20px] list-disc'>
                     HTML
                </li>
                 <li className='text-black text-[18px] ml-12 text-left min-[1400px]:text-[26px] min-[768px]:text-[20px] list-disc'>
                    CSS
            ...
            <div className="  w-[330px] h-[230px]  border-transparent border-[2px] ml-[-20px] mt-[100px] min-[1400px]:ml-[-250px] min-[1400px]:w-[700px] min-[1400px]:h-[300px] 
            xl:ml-[50px] xl:w-[700px] min-[768px]:ml-[10px] min-[768px]:w-[500px]">     
            ...
            min-[768px]:ml-[10px] min-[768px]:w-[500px]  ">    
                <p className=" text-black text-[18px] ml-5 text-left min-[1400px]:text-[26px]  min-[768px]:text-[22px]">Il design del sito è basato su uno stile semplice e ordinato, 
                    con pochi elementi sullo schermo per un esperienza utente pulita. La navbar ha un design unico e originale e comprende il logo alla sinistra e alla destra le
            ...
            min-[768px]:ml-[10px] min-[768px]:w-[500px]">          
                <p className=" text-black text-[18px] ml-5 text-left min-[1400px]:text-[26px]  min-[768px]:text-[22px]">Il sito si apre con un loader con due rombi di diverso colore 
                    e dimensione che girano con tempi diversi. Dopo il loader si viene portati nella home della pagina, con a sinistra la descrizione del sito e a destra in 
