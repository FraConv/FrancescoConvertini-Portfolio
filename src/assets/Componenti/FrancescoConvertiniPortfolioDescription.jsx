        ...
        <>
            ...
            <Navbar></Navbar>
                ...
                <div className="flex justify-center items-center mt-[300px]">
                    <h1 className="text-black text-[1.7em] text-left   min-[1400px]:text-[70px] xl:text-[50px]">
                    Francesco Convertini</h1>
                </div>


                <div className="flex justify-center items-center mt-[90px]">
                    <p className=" text-black text-[20px] text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">
                ...
                <div className="flex justify-center items-center mt-[300px]">
                    <h3 className=" text-black text-[29px] text-left min-[1400px]:text-[35px]">
                        Programmazione:
                    </h3>
                </div>
                ...
                <div className="flex justify-center items-center mt-[300px]">         
                    <h1 className=" text-black scale-120  text-left min-[1400px]:text-[70px]">
                        Design sito web
                    </h1>   
                </div>
                ...
                <div className="flex justify-center items-center mt-[90px]">    
                    <p className=" text-black text-[18px]  text-left min-[1400px]:text-[26px]  min-[768px]:text-[22px]">Il design del sito è basato su uno stile semplice e ordinato, 
                ...
                <div className="flex justify-center items-center mt-[90px]">
                <p className=" text-black text-[18px]  text-left min-[1400px]:text-[26px]  min-[768px]:text-[22px]">Il font utilizzato per questo sito è il Poppins.</p>
                </div>
                ...
                <div className="flex justify-center items-center mt-[90px]">
                <p className=" text-black text-[18px]  text-left min-[1400px]:text-[26px]  min-[768px]:text-[22px]">Per la versione mobile è stato fatto un lavoro accurato, per rendere il tutto 
