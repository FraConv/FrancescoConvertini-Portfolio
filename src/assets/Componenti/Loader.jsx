...
function Loader() {
  ...
  return (
    <>
      <div
        className={`transform transition-all duration-1000 grid grid-cols-5 w-[100vw] h-[700vw] bg-[#faf5eb] z-40 fixed ml-[-33px] mt-[-100px] min-[414px]:ml-[-32px] 
        min-[390px]:ml-[-32px] min-[430px]:ml-[-32px] 
        min-[412px]:ml-[-32px] min-[1400px]:w-[110%] min-[1400px]:left-0 xl:w-[110%] xl:left-0 min-[768px]:left-0 min-[768px]:w-[120%] ${ loading ? "visible" : "hidden"}`} // Aggiungi transizione opacità
      >
