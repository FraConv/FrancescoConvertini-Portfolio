        ...
        <>
            ...
            <Navbar></Navbar>
                ...
                <div className="flex justify-center items-center mt-[300px]">
                    <h1 className=" text-white  text-[48px] text-left min-[1400px]:text-[70px] xl:text-[50px]">The Thing under the bed
                    </h1>
                </div>
                ...
                <div className="flex justify-center items-center mt-[90px]">
                    <p className=" text-white  text-[17px] text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">lo scrittore Luke Smith per la copertina
                ...
                <div className="flex justify-center items-center mt-[100px]">
                    <p className=" text-white text-[17px] text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">I sui colori leggermente scuri vanno a dare un senso 
                ...
                <div className="flex justify-center items-center mt-[90px]">
                    <p className=" text-white  text-[17px] text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">Il font utilizzato per questa illustrazione è il Minion Variable Concept.</p>
                </div>


                <div className="flex justify-center items-center mt-[300px]">
                    <h1 className=" text-white text-[30px] text-left">Mockup</h1>
                </div>
