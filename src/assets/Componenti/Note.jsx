...
<h1 className=" text-black text-[30px] ml-5 text-left min-[1400px]:text-[70px] xl:text-[50px]">Airnote
</h1>
</div>
...
min-[768px]:ml-[-70px] min-[768px]:w-[500px]">
<p className=" text-black text-[20px] ml-5 text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">Logo per una marca di auricolari bluetooth.</p>
</div>

<img className=" w-[400px] h-[400px]  mt-5 ml-[-32px] pl-[20px] min-[1400px]:scale-[1.30] min-[1400px]:ml-[530px] min-[1400px]:mt-[-110px] xl:ml-[630px] xl:scale-[1.20]
xl:mt-[-40px] " src="airnotev2.svg" alt="" />
...
<div className="  w-[330px] h-[530px]  border-transparent border-[2px] ml-[-20px] mt-[100px] min-[1400px]:ml-[-250px] min-[1400px]:w-[700px] xl:ml-[50px] xl:w-[700px]
min-[768px]:ml-[-70px] min-[768px]:w-[500px]">
<p className=" text-black text-[18px] ml-5 text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">Per la creazione del logo mi sono ispirato al nome della marca di auricolari, e da questo punto di partenza ho disegnato una nota musicale che vada a ricordare allo stesso tempo due auricolari bluetooth, creando cosi un'immagine unica e identificatica.
<br />
<br />
...
<img className=" w-[400px] h-[400px]  mt-5 ml-[-62px] pl-[20px] min-[1400px]:ml-[520px] min-[1400px]:mt-[-230px] min-[1400px]:scale-[1.20] xl:ml-[600px] xl:mt-[-200px]" src="airnote.svg" alt="" />
...
min-[768px]:ml-[-70px] min-[768px]:w-[500px]">
<p className=" text-black text-[18px] ml-5 text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">I suoi colori nero e bianco vanno a richiamare semplicità, professionalità e serietà.
</p>
</div>
...
min-[768px]:ml-[-70px] min-[768px]:w-[500px]">
<p className=" text-black text-[18px] ml-5 text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">Il font utilizzato per questo logo è il Gotham Bold</p>
</div>
...
min-[768px]:ml-[-70px] min-[768px]:w-[500px]">
<h1 className=" text-black scale-120 ml-5 text-left min-[1400px]:text-[70px]">Mockup</h1>
</div>

<img className=" w-[400px] h-[400px]  mt-5 ml-[-32px] pl-[20px] min-[1400px]:scale-[1.30] min-[1400px]:ml-[530px] min-[1400px]:mt-[-110px]" src="airnotev2.svg" alt="" />
