        ...
        <>
            ...
            <Navbar></Navbar>
                ...
                <div className="flex justify-center items-center mt-[300px]">
                    <h1 className=" text-white text-[30px] text-left min-[1400px]:text-[70px] xl:text-[50px]">Airnote
                    </h1>
                </div>
                ...
                <div className="flex justify-center items-center mt-[90px]">
                    <p className=" text-white text-[18px] text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">Per la creazione del logo mi sono ispirato al 
                ...
                <div className="flex justify-center items-center flex-col">
                    <p className="text-white text-[18px] mt-[200px] text-left font-semibold min-[1400px]:text-[26px] min-[768px]:text-[22px]">Risultato finale:</p>
                ...
                <div className="flex justify-center items-center mt-[100px]">
                    <p className=" text-white text-[18px] text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">I suoi colori nero e bianco vanno a richiamare semplicità, 
                ...
                <div className="flex justify-center items-center mt-[90px]">
                <p className=" text-white text-[18px] text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">Il font utilizzato per questo logo è il Gotham Bold</p>
                </div>
