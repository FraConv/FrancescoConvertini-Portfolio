        ...
        <>
            ...
            <Navbar></Navbar>
                ...
                <div className="flex justify-center items-center mt-[300px]">
                    <h1 className=" text-white scale-120 text-[48px] min-[1400px]:text-[70px] text-left xl:text-[50px]">Lucky Roll</h1>
                </div>


                <div className="flex justify-center items-center mt-[90px]">
                    <p className=" text-white text-[20px] min-[1400px]:text-[26px] text-left min-[768px]:text-[22px]">Applicazione web che simula il lancio dei dadi a sei faccie.</p>
                </div>
                ...
                <div className="flex justify-center items-center mt-[300px]">
                    <h2 className=" text-white text-[23px] min-[1400px]:text-[35px]">Programmazione:</h2>
                </div>
                ...
                <div className="flex justify-center items-center mt-[300px]">
                    <h1 className=" text-white scale-120 min-[1400px]:text-[70px] text-[30px] text-left">Design web app</h1>
                </div>


                <div className="flex justify-center items-center mt-[90px]">
                    <p className=" text-white text-[17px] text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">Il design dell'app è basato su uno stile 
                ...
                <div className="flex justify-center items-center mt-[300px]">
                    <h3 className=" text-white text-[23px] min-[1400px]:text-[35px]">Color palette:</h3>
                </div>
                ...
                <div className="flex justify-center items-center mt-[90px]">
                    <p className=" text-white text-[17px] text-left min-[1400px]:text-[26px] min-[768px]:text-[22px]">Il font utilizzato per l'applicazione è Encode Sans.</p>
                </div>


                <div className="flex justify-center items-center mt-[300px]">
                    <h1 className=" text-white scale-120 text-left min-[1400px]:text-[70px] text-[30px]">Versione mobile</h1>
                </div>


                <div className="flex justify-center items-center mt-[90px]">
                    <p className="text-white text-[17px] flex justify-center items-center text-left  min-[1400px]:text-[26px] min-[768px]:text-[22px]">Per la 
